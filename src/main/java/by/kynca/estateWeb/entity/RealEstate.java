...
public class RealEstate extends AbstractBean {
    ...
    public RealEstate(Double area, Double price, String addInfo, boolean isRented, RealEstateType realEstateType,
                      boolean deleted, Address address, Client client, Flat flat) {
        this.area = area;
        this.price = price;
        this.addInfo = addInfo;
        this.isRented = isRented;
    ...
    public boolean equals(Object o) {
        ...
        return isRented == that.isRented && deleted == that.deleted && Objects.equals(realEstateId, that.realEstateId) && area.equals(that.area) && price.equals(that.price) && addInfo.equals(that.addInfo) && realEstateType == that.realEstateType && address.equals(that.address) && client.equals(that.client) && Objects.equals(flat, that.flat);
    }

    @Override
    public int hashCode() {
        return Objects.hash(realEstateId, area, price, addInfo, isRented, realEstateType, deleted, address, client, flat);
    }
